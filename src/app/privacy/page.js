        ...
        <Card className="border-cyber-border bg-cyber-card/50 backdrop-blur-xl">
          ...
          <CardContent className="prose prose-invert max-w-none">
            <p className="text-lg">
              ...
              data Kluster collects, why, and how we protect it.
            </p>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                ...
                <li>
                  Your college/institution if required for academic reasons
                </li>
                <li>Law enforcement only when legally required</li>
              </ul>
              <p className="text-white font-semibold mt-4">
                We never share or sell user data to advertisers.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground mt-3">
                (See{" "}
                <a href="/cookies" className="text-neon-cyan hover:underline">
                  Cookie Policy
                </a>
                )
              </p>
