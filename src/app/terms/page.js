      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-cyber-card/50 backdrop-blur-xl rounded-lg border border-cyber-border p-8 md:p-12">
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-foreground">
            <p className="text-lg">
              Welcome to Kluster. By accessing or using Kluster, you agree to the following Terms & Conditions. 
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                <li>You must be a student, faculty, or authorized member of the participating college or institution.</li>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                <li>You are responsible for safeguarding your login ID and password.</li>
                <li>You must provide accurate details including name, department, and institutional email.</li>
                <li>You agree not to impersonate others or create fake accounts.</li>
              </ul>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">3. Use of the Platform</h2>
              ...
              <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                ...
                <li>Upload pirated content or copyrighted material without permission</li>
              </ul>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                <li>You own the intellectual property rights for projects, posts, files, and documents you upload.</li>
                <li>By uploading, you grant Kluster a non-exclusive, royalty-free license to display your content on the platform.</li>
              </ul>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">5. Platform Features</h2>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                <li>Is not responsible for inaccuracies or user-generated content</li>
                <li>Is not liable for any academic, career, or financial outcomes</li>
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-3">We may suspend or terminate your access for:</p>
              <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                We may update these Terms. Continued use of the platform means you accept changes.
              </p>
            </section>
